    ...
    for model_name in models_list: 
        ...
        for sheet in sheet_name_list: 
            ...
            if sheet_name == 'hun_han_alle':
                ...
                to_filename = 'experiments/hanna_og_hans/data/embeddings_{}_{}.txt'.format(sheet_name, name[models_list.index(model_name)])
        ...
        to_filename = 'experiments/hanna_og_hans/data/diff_embeddings_{}.txt'.format(name[models_list.index(model_name)])
