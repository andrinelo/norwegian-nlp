...
def run(model, model_name, hanna_text, hans_text): 
    ...
    np.savetxt('debiasing/gender_swap/hanna_og_hans/data/{}_hans_SA.txt'.format(model_name), hans_emb.numpy())
    np.savetxt('debiasing/gender_swap/hanna_og_hans/data/{}_hanna_SA.txt'.format(model_name), hanna_emb.numpy())
    ...
    np.savetxt('debiasing/gender_swap/hanna_og_hans/data/{}_hans_TWA.txt'.format(model_name), hans_avg.numpy())
    np.savetxt('debiasing/gender_swap/hanna_og_hans/data/{}_hanna_TWA.txt'.format(model_name), hanna_avg.numpy())
...
if __name__ == '__main__': 
    ...
    run(male2female, 'male2female', hanna_text, hans_text)
