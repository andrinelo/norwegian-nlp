...
def plot_word_cloud(word_cloud_string, model_name, male_or_female):
    if (male_or_female == 'male'):
        ...
        word_cloud.to_file("experiments/masked_adjectives/word_cloud_{}_{}.png".format(male_or_female, model_name))
        word_cloud.to_file("experiments/masked_adjectives/word_cloud_{}_{}.eps".format(male_or_female, model_name))
    else:
